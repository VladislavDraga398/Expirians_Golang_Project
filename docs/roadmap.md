...
**Версия:** v4.2 | **Обновлено:** 2026-03-08 | **Статус:** Sprint 3 Active

---

## TL;DR
- Базовое ядро OMS стабилизировано в рамках Sprint 1.
- Текущий фокус: Sprint 3 — идентификация и policy слотов.
...
### Sprint 2 - Delivery Domain Foundation (Completed)
...
- Публичный `CourierService` в runtime:
  - регистрация/получение курьера,
  - управление зонами,
  - создание/просмотр слотов,
  - чтение vehicle capabilities.
...
- Слоты 4/8/12 часов.
- Ночной слот `20:00-08:00` только для курьеров на авто. **(реализовано в runtime)**
...
**Статус:** частично реализован заранее (MVP рейтинга + summary + reason-теги в runtime/API).
